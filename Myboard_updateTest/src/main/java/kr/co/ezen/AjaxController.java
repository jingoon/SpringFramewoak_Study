...
public class AjaxController {
	...
	public List<SearchPageTO<BoardVO>> soapList(@RequestParam Map<String, String>map) throws Exception {//@RequestParam, map으로 데이터 받음
		String strList = map.get("list").toString();
		System.out.println(strList);
		ObjectMapper mapper = new ObjectMapper();
		List<SearchPageTO<BoardVO>> list= mapper.readValue(strList, new TypeReference<List<SearchPageTO<BoardVO>>>() {
		});
	...
	public SearchPageTO<BoardVO> soapJson(SearchPageTO<BoardVO> to) {
